...
class Swarm{
    ...
    void clearHelp(Robot* r2);
    Robot* removeHelp(Robot* r2, int id);
    void insertHelp(const Robot& robot, Robot* r2 );
    int heightHelp(Robot* r2);
    int max(int a, int b);
    bool fBotHelp(int id, Robot* r2) const;
    Robot* leftRotation(Robot* r2);
    Robot* rightRotation(Robot* r2);
    Robot* stateHelper(int id, Robot* r2);
    void listHelp(Robot* r2) const;
    void deadHelper(Robot* r2);
    Robot* leftSet(Robot* r2);
    // ***************************************************
