...
static const yytype_int8 yytranslate[] =
{
      ...
      21,    22,    15,    14,     2,    13,    20,    16,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,    10,     2,    19,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
       2,     2,     2,     2,     2,     2,     2,     2,     2,     2,
...
static const char *const yytname[] =
{
  ...
  "AND", "OR", "EQUAL", "GT", "LT", "'='", "'|'", "'&'", "'-'", "'+'",
  "'*'", "'/'", "UMINUS", "'\\n'", "'?'", "'.'", "'('", "')'", "$accept",
  "session", "toplevel", "expr", YY_NULLPTR
};
...
{
     -14,     0,   -14,   -14,    -8,   -14,    28,   -14,   -14,    28,
     -13,    47,    28,     3,    29,   -14,    28,    28,    28,    28,
      28,    28,    28,    28,    28,    47,   -14,    47,    47,    59,
      59,    59,     1,     1,     3,     3
};
...
{
       2,     3,    12,     4,     5,    15,    16,    17,    16,    17,
       0,     0,    13,     6,     0,    14,    23,    24,    25,     7,
       8,     9,    27,    28,    29,    30,    31,    32,    33,    34,
      35,     4,     5,     0,    16,    17,    18,    19,    20,     0,
       0,     6,    21,    22,    23,    24,     0,     0,     0,     9,
       0,    26,    16,    17,    18,    19,    20,     0,     0,     0,
      21,    22,    23,    24,    16,    17,     0,    19,    20,     0,
       0,     0,    21,    22,    23,    24
};

static const yytype_int8 yycheck[] =
{
       0,     1,    10,     3,     4,    18,     5,     6,     5,     6,
      -1,    -1,     6,    13,    -1,     9,    15,    16,    12,    19,
      20,    21,    16,    17,    18,    19,    20,    21,    22,    23,
      24,     3,     4,    -1,     5,     6,     7,     8,     9,    -1,
      -1,    13,    13,    14,    15,    16,    -1,    -1,    -1,    21,
      -1,    22,     5,     6,     7,     8,     9,    -1,    -1,    -1,
      13,    14,    15,    16,     5,     6,    -1,     8,     9,    -1,
      -1,    -1,    13,    14,    15,    16
};
...
{
       0,    24,     0,     1,     3,     4,    13,    19,    20,    21,
      25,    26,    10,    26,    26,    18,     5,     6,     7,     8,
       9,    13,    14,    15,    16,    26,    22,    26,    26,    26,
      26,    26,    26,    26,    26,    26
};
