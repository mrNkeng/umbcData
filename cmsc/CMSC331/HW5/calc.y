...
%token <dval> NUMBER
 ...
 // Declare the new tokens
%token AND OR EQUAL GT LT
...
%left '|' /* OR has higher precedence than = */
%left '&' /* AND has higher precedence than | */
%left EQUAL /* EQUAL has higher precedence than & and | */
%right GT LT /* GT and LT have higher precedence than EQUAL */
%left '-' '+' /* These have higher precedence than GT and LT */
%left '*' '/' /* These have higher precedence than + and - */
